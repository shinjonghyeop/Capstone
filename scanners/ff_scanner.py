...
# FFUF Configuration
UNIFIED_WORDLIST = "../wordlists/unified_wordlist.txt"
RECURSION_DEPTH = 3
THREADS = 100
OUTPUT_DIR="./ffuf_output"


def run_ffuf(url: str, output_dir=OUTPUT_DIR, cookie='test=') -> Optional[str]:
    """
    ...
    if os.path.exists(UNIFIED_WORDLIST):
        ...
        cmd = build_ffuf_command(url, UNIFIED_WORDLIST, json_file, cookie)
